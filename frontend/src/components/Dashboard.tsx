          ...
          {activeTab === "init" ? (
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xs text-muted-silver mt-1">
                  Trigger an automated payout on the contract. The contract will pull the specified stablecoin token amount from your account and instantly split it among the configured addresses.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-muted-silver block">
                    Stablecoin Token Address (SAC / mock USDC)
                  </label>
                  <input
                    type="text"
                    value={tokenAddress}
